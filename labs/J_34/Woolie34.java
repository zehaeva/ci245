...
/**
 * Woolie34 - simulates a woolie crossing a bridge
 * <p>
 ...
 * @author      Jim Vallino
 */
public class Woolie34 extends Thread {
    
    /**
     * Construct a new Woolie34 object that can be started in a separate
     * thread.  The constructor will simply initializes all of the 
     * instance fields.
     *
     * @param       n    the name of this Woolie34
     * @param       c    the number of seconds it takes the Woolie34 to cross
     *                   the bridge
     * @param       d    the city the Woolie34 is heading to
     * @param       b    the bridge the Woolie34 is crossing
     *
     * Preconditions:<ul>
    ...
    /**
     * This method handles the Woolie34's crossing of the bridge.  There
     * are several messages that must be displayed to describe the Woolie34's
     * progress crossing the bridge.  <I>Note: In all the following
     * messages</I>
     * &quot;<code>name</code>&quot; <I>is the name of the Woolie34.</I>
     *
     * <ul>
     * <li>When the Woolie34 thread starts the message<br>
     * <blockquote><code>name has arrived at the bridge.</code></blockquote>
     * is displayed.
     * <li>When the Woolie34 starts crossing the bridge, at time 0, the message
     * <br>
     * <blockquote><code>name is starting to cross.</code></blockquote>
     * is displayed.
     * <li>For every one second interval, beyond time 0, that the Woolie34 is on
     * the bridge a message<br>
     * <blockquote><code>name x seconds.</code></blockquote>
     * should be printed where &quot;<code>x</code>&quot;
     * is the number of seconds that the Woolie34 has been on the bridge.
     * <li>When the Woolie34 reaches its destination display the
     * message<br>
     * <blockquote><code>name leaves at city.</code></blockquote>
     * where &quot;<code>city</code>&quot; is the Woolie34's destination.
     * </ul>
     */
     ...
     */
    private Bridge34 theBridge;

    /**
     * The troll guarding the bridge
     */
    private Troll34 bridgeGuard;
}
