...
public class WoolieQueue {
	 ...
	 *
	 * @param caller the Woolie34 to be inserted.
	 */
	public synchronized void insert( Woolie34 caller ) {
	 ...
	 *
	 * @return the Woolie34 that has been in the queue for
	 *         the longest time, or null if the queue is
	 *         empty.
	 */
	public synchronized Woolie34 peek() {
		Woolie34 result = null;
		try {
			result = (Woolie34)woolies.getLast();
		}
	 ...
	 *         the longest time.
	 */
	public synchronized Woolie34 remove() {
		...
		return (Woolie34)woolies.removeLast();
	}
